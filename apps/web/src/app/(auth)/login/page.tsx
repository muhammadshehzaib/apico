  ...
  return (
    <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-bg-secondary/80 rounded-2xl p-8 border border-bg-tertiary/60 shadow-[0_30px_80px_rgba(0,0,0,0.45)] backdrop-blur">
        <div className="mb-6">
          <div className="text-xs uppercase tracking-[0.3em] text-text-muted text-center">Welcome Back</div>
          <h1 className="text-2xl font-semibold text-center mt-2">Login to Apico</h1>
        </div>
